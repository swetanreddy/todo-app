...
class DoneTasksTeam extends StatefulWidget {

  DoneTasksTeam({Key? key, this.taskFilter}) : super(key: key);
  final taskFilter;
  @override
  _DoneTasksTeamState createState() => _DoneTasksTeamState();
}


class _DoneTasksTeamState extends State<DoneTasksTeam> {
...
Widget _personalDoneTasks(dept) => StreamBuilder<QuerySnapshot>(
  stream: FirebaseFirestore.instance.collection('spark_assignedTasks').where("status", isEqualTo: "Done").where("dept", isEqualTo: dept).snapshots(),
