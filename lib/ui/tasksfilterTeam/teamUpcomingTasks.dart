...
class UpcomingTasksTeam extends StatefulWidget {

  UpcomingTasksTeam({Key? key, this.taskFilter}) : super(key: key);
  final taskFilter;
  @override
  _UpcomingTasksTeamState createState() => _UpcomingTasksTeamState();
}


class _UpcomingTasksTeamState extends State<UpcomingTasksTeam> {
...
Widget _UpcomingTeamTasks(dept) => StreamBuilder<QuerySnapshot>(
  stream: FirebaseFirestore.instance.collection('spark_assignedTasks').where("status", isEqualTo: "InProgress").where("dept", isEqualTo: dept).snapshots(),
