...
class createdTasksPersonal extends StatefulWidget {

  createdTasksPersonal({Key? key, this.taskFilter}) : super(key: key);
  final taskFilter;
  @override
  _createdTasksPersonalState createState() => _createdTasksPersonalState();
}


class _createdTasksPersonalState extends State<createdTasksPersonal> {
  @override
