...
class doneTasksPersonal extends StatefulWidget {

  doneTasksPersonal({Key? key, this.taskFilter}) : super(key: key);
  final taskFilter;
  @override
  _doneTasksPersonalState createState() => _doneTasksPersonalState();
}


class _doneTasksPersonalState extends State<doneTasksPersonal> {
  @override
